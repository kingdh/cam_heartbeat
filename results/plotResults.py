...
print
"Avg error BPM: " + str(np.mean(errorBPM))
print
"Std dev BPM: " + str(np.std(errorBPM))
print
"Avg error percent: " + str(np.mean(errorPercent))
print
"Std dev percent: " + str(np.std(errorPercent))
print
"Percent outliers: " + str(percentOutliers)
